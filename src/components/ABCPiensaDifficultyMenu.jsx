...
function ABCPiensaDifficultyMenu({ onGoBack, onDifficultySelected }) {
  return (
    <MenuContainer>
      ...
      <TitleContainer>
        <TitleWord delay={0}>Selecciona</TitleWord>
        <TitleWord delay={0.2}>el</TitleWord>
        <TitleWord delay={0.4}>nivel</TitleWord>
        <TitleWord delay={0.6}>de</TitleWord>
        <TitleWord delay={0.8}>dificultad</TitleWord>
      </TitleContainer>
...
export default ABCPiensaDifficultyMenu;